...
| `PROJECT_PRINCIPLES.md` | Delegation model, guided/un-guided modes, workflow library | When initiating workflows or designing agent delegation |
| `ROADMAP_NOTES.md` | Research on comparable mechanisms; living roadmap notes | When planning new features or comparing approaches |
