...
| MCP tools | 29 (7 publishing + 1 tiktok-status + 8 content-intelligence + 1 brand_voice + 1 link_tag + 5 queue + 3 observability + 1 account_info + 2 media) |
...
| Tests | 77 unit (`node:test`) + 25-check MCP smoke test |
