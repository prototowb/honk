...
| MCP tools | 31 (7 publishing + 1 tiktok-status + 8 content-intelligence + 1 workflow_list + 1 brand_voice + 1 brand_schema + 1 link_tag + 5 queue + 3 observability + 1 account_info + 2 media) |
...
| Tests | 154 unit (`node:test`) + 45-check MCP smoke test |
