...
export function normalizeScheduledAt(input: string | null | undefined): string | null {
...
export function timezoneWarning(input: string | null | undefined): string {
  return (input && hasExplicitTimezone(input))
    ? ''
