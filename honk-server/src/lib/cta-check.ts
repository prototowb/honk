...
export function hasCta(platform: string, content: Record<string, unknown>): boolean {
...
export function ctaNote(platform: string, content: Record<string, unknown>): string {
