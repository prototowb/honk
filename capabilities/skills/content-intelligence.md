...
description: >
  ...
  versions", "check my Honk setup", "which platforms are configured", "show the
  ...
  Credential-free content prep, validation, and introspection tools on the honk
...
Tools on the `honk` MCP server. None of these publish; all but the analytics
